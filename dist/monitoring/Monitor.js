...
export class Monitor {
    ...
    recordScrapeResult(success, url, duration, dataPoints) {
    ...
    labelsMatch(metricLabels, filterLabels) {
        if (!filterLabels)
            return true;
        if (!metricLabels)
            return false;
